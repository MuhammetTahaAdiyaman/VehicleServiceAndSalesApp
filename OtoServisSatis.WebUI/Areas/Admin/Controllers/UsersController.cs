...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        private readonly IService<Rol> _servicerRol;

        public UsersController(IUserService service, IService<Rol> servicerRol)
        {
            _service = service;
            _servicerRol = servicerRol;
        }
        ...
        {
            ViewBag.RolId = new SelectList(await _servicerRol.GetAllAsync(), "Id","Adi");
            return View();
        }
